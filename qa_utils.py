...
@dataclass
class Config:
    NER_MODEL: str = "huggingface/ner-english-ontonotes-fast/pytorch_model.bin"
    QG_MODEL: str = "huggingface/t5-base-finetuned-question-generation-ap"
    QA_MODEL: str = "huggingface/roberta-base-squad2"
