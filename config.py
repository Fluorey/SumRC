...
def cnndm_setting(args):
    ...
    args.report_freq = getattr(args, "report_freq", 25)
    ...
    args.pg_weight = getattr(args, "pg_weight", 1)
    args.rank_weight = getattr(args, "rank_weight", 0.2)
    args.model_type = getattr(args, "model_type", "huggingface/bart-large-cnn")
    ...
    args.max_lr = getattr(args, "max_lr", 2e-4)
    # args.max_lr_dis = getattr(args, "max_lr_dis", 5e-4)
    args.scale = getattr(args, "scale", 1)
    args.score_mode = getattr(args, "score_mode", "log")
    args.dataset = getattr(args, "dataset", "cnn_dm")
    ...
    args.ranking_metric = getattr(args, "ranking_metric", "factCC")
    args.eval_interval = getattr(args, "eval_interval", 25)
    args.num_beams = getattr(args, "num_beams", 4)
    args.can_num = getattr(args, "can_num", 6)
...
def xsum_setting(args):
    ...
    args.pg_weight = getattr(args, "pg_weight", 1)
    args.rank_weight = getattr(args, "rank_weight", 0.2)
    args.model_type = getattr(args, "model_type", "huggingface/pegasus-xsum")
    args.warmup_steps = getattr(args, "warmup_steps", 10000)
    args.normalize = getattr(args, "normalize", True)
    args.grad_norm = getattr(args, "grad_norm", 0)
    args.seed = getattr(args, "seed", 970903)
    ...
    args.max_num = getattr(args, "max_num", 6)  # 记得改参考摘要数量！！！！！！！
    ...
    args.adding = getattr(args, "adding", 0)
    args.ranking_metric = getattr(args, "ranking_metric", "factCC")
    args.eval_interval = getattr(args, "eval_interval", 1250)
